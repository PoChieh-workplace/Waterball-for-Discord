...
<img src="https://raw.githubusercontent.com/PoChieh-workplace/WaterBall/main/docs/photo/WaterBall-icon.png" alt="waterball-icon" style="height:100px;"/> X <img src="https://github.com/PoChieh-workplace/WaterBall/blob/main/docs/photo/whsh.jpg?raw=true" alt="whsh-icon" style="height:100px;"/>
...
|目次                               | 目次                              |  
|:--------------------------------  | :------------------------         | 
|**[I、前言]()**                    |**[II、什麼是-waterball-機器人](#二什麼是-waterball-機器人)**  | 
|**[III、指令說明]()**              |**[III-a、基本指令]()**            |
|**[III-b、音樂指令]()**            |**[III-c、RPG]()**                 |
|||
|  | |
...
> 透過 [discord.py](https://discordpy.readthedocs.io/en/latest/index.html) 撰寫程式碼，優化文華伺服器，提供方便、有趣、熱鬧的社群環境。學生們可以在這裡尋找志同道合的朋友、使用便捷安靜又隱私的語音系統
##### RPG、YTmusic、KBwhsh 等各式功能應有盡有 
